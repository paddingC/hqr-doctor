<template>
  <div class="login-container">
    <el-container style="height: 100vh">
      <el-header
        class="el-header-box"
        v-if="realmName!=null && realmName != ''"
      >{{realmName.companysortname}}药事服务医生端</el-header>
      <el-header class="el-header-box" v-else>药事服务医生端</el-header>
      ...
      <el-footer
        class="login-footer"
        v-if="realmName!=null && realmName != ''"
      >{{realmName.companyname}}远程药事服务平台</el-footer>
    ...
    loginback: function(data) {
        if (data.status === 207) {
            this.$confirm(data.msg, '提示', {
                ...
                this.$socket.emit('logindoctor', JSON.stringify({
            ...
            if (data.data) {
                ...
                sessionStorage.setItem("isinventory",  data.data.isinventory)
                //   this.$store.commit("user/SET_ISINVENTORY", data.isinventory);
